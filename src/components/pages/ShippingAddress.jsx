        ...
        <div style={{ margin: '3.5rem 0rem', maxHeight: '100vh', maxWidth: '100vw' }}>
            ...
            <Container>
                <Form>
                    ...
                    <SmallContainer>
                        <SmallInput id='governorate/state' name='governorate/state' placeholder='Governorate/State' />
                        <SmallInput id='city' name='city' placeholder='City' />
                    ...
                    <SmallContainer>
                        ...
                        <Link to='/payment-method'>
                            <PaymentButton type="submit">Continue to Payment</PaymentButton>
                        </Link>
                    </SmallContainer>
                </Form>
            </Container>
